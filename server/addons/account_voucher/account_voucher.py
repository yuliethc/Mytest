...
#    _rec_name = 'number'
    ...
    _columns = {
        ...
        'amount': fields.float('Total', digits_compute=dp.get_precision('Total'), required=True, readonly=True, states={'draft':[('readonly',False)]}),
        'tax_amount':fields.float('Tax Amount', digits_compute=dp.get_precision('Total'), readonly=True),
