...
class datos_presupuesto(osv.osv):
    _name = 'sale.order' # Aqui va el mismo nombre de la clase que se hereda
    _inherit = 'sale.order' # Permite la herencia propiamente dicho del modulo product 
